...
--[[
function npc:hit( damage )
	damage = damage - self:armor(); if damage < 0 then damage = 0 end
	self.current_hp = self.current_hp - damage;
	if self.current_hp < 0 then self.current_hp = 0 end
end--]]
...
function npc:wound( dmg )
	print( dmg, self.name, self.current_hp )
